...
public class lamdaTestSteps {
    ...
    public void fillManditoryParams() {
        page.locator("[id=\"name\"]").fill("diksha");
        page.locator("[id=\"inputEmail4\"]").fill("diksha@mail.com");
        page.locator("[id=\"inputPassword4\"]").fill("diksha@123");
        page.locator("[id=\"company\"]").fill("lamda");
        page.locator("[id=\"websitename\"]").fill("test");
        page.locator("[id=\"inputCity\"]").fill("pun");
        page.locator("[id=\"inputAddress1\"]").fill("pun1");
        page.locator("[id=\"inputAddress2\"]").fill("pun2");
        page.locator("[id=\"inputState\"]").fill("lon");
        page.locator("[name=\"country\"]").selectOption("UK");
        page.locator("[id='inputZip']").fill("12332");
    }
